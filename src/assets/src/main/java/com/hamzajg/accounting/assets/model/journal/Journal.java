...
public interface Journal {
    ...
    Completes<JournalState> create(final LocalDate date, final String type, final String title, final String exerciseId, final JournalLine journalLines);

    static Completes<JournalState> create(final Stage stage, final LocalDate date, final String type, final String title, final String exerciseId, final JournalLine journalLines) {
