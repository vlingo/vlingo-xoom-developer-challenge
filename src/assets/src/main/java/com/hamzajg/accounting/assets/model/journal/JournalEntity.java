...
public final class JournalEntity extends StatefulEntity<JournalState> implements Journal {
  ...
  @Override
  public Completes<JournalState> create(final String date, final String type, final String title, final JournalLine journalLines) {
    final JournalState stateArg = state.create(date, type, title, journalLines);
