...
public class EmployeeData {
  ...
  public static EmployeeData from(final EmployeeState employeeState) {
    ...
    return from(employeeState.id, employeeState.exerciseId, fullName, address, employeeState.workingPeriod, cost);
  }

  public static EmployeeData from(final String id, final String exerciseId, final FullNameData fullName,
      final AddressData address, final double workingPeriod, final MoneyData cost) {
    return new EmployeeData(id, exerciseId, fullName, address, workingPeriod, cost);
  }
  ...
  private EmployeeData(final String id, final String exerciseId, final FullNameData fullName, final AddressData address,
      final double workingPeriod, final MoneyData cost) {
    this.id = id;
