...
public interface Employee {
  ...
  Completes<EmployeeState> create(final String exerciseId, final FullName fullName, final Address address, final double workingPeriod, final Money cost);

  static Completes<EmployeeState> create(final Stage stage,final String exerciseId, final FullName fullName, final Address address, final double workingPeriod, final Money cost) {
    ...
    return _employee.create(exerciseId, fullName, address, workingPeriod, cost);
  }
