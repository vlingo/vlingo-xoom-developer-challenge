...
public final class CustomerEntity extends StatefulEntity<CustomerState> implements Customer {
    ...
    @Override
    public Completes<CustomerState> create(final String name, final String type, final String activityType,
        ...
        final CustomerState stateArg = state.create(name, type, activityType, creationDate.toString(), capital, address,
                legalStatus, associates);
