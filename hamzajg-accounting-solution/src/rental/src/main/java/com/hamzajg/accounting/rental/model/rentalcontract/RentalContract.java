...
public interface RentalContract {
    ...
    Completes<RentalContractState> create(final String startDate, final String endDate, final String customerId,
                                          final int paymentPeriod, final Money price);

    static Completes<RentalContractState> create(final Stage stage, final String startDate, final String endDate,
                                                 final String customerId, final int paymentPeriod, final Money price) {
