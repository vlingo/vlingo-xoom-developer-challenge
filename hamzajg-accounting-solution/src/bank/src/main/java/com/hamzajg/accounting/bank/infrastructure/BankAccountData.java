...
public class BankAccountData {
  ...
  public static BankAccountData from(final BankAccountState bankAccountState) {
    ...
    return from(bankAccountState.id, bankAccountState.rib, bankAccountState.iban, bankAccountState.type, bankAccountState.bicCode, balance, bankAccountState.agency);
  }

  public static BankAccountData from(final String id, final String rib, final String iban, final String type, final String bicCode, final MoneyData balance, final String agency) {
