...
public class ExchangeDispatcher implements Dispatcher<Dispatchable<Entry<String>, State<String>>>, ConfirmDispatchedResultInterest {
  ...
  public ExchangeDispatcher(final Exchange ...producerExchanges) {
    this.eventsByExchangeName.put("banks-exchange", new HashSet<>());
    this.eventsByExchangeName.get("banks-exchange").add(BankAccountCreated.class.getCanonicalName());
    this.eventsByExchangeName.put("bank-journals-exchange", new HashSet<>());
    this.eventsByExchangeName.get("bank-journals-exchange").add(JournalLinesRemoved.class.getCanonicalName());
    this.eventsByExchangeName.get("bank-journals-exchange").add(JournalDescriptionChanged.class.getCanonicalName());
    this.eventsByExchangeName.get("bank-journals-exchange").add(JournalCreated.class.getCanonicalName());
    this.eventsByExchangeName.get("bank-journals-exchange").add(JournalLinesChanged.class.getCanonicalName());
    this.eventsByExchangeName.get("bank-journals-exchange").add(JournalDateChanged.class.getCanonicalName());
    this.eventsByExchangeName.get("bank-journals-exchange").add(JournalLinesAdded.class.getCanonicalName());
