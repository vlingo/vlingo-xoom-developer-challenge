...
import com.hamzajg.accounting.bank.infrastructure.persistence.CommandModelStateStoreProvider;
...
public class Bootstrap implements XoomInitializationAware {
    ...
    public void onInit(final Grid grid) {
        ...
        CommandModelStateStoreProvider.using(grid.world().stage(), sourcedTypeRegistry,
