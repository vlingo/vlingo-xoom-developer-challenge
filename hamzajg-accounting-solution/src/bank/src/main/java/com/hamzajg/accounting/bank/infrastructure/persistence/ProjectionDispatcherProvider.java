  ...
  public static ProjectionDispatcherProvider using(final Stage stage) {
    ...
    final List<ProjectToDescription> descriptions =
            Arrays.asList(
                    ...
                    ProjectToDescription.with(JournalProjectionActor.class, JournalLinesRemoved.class.getName(), JournalDescriptionChanged.class.getName(), JournalCreated.class.getName(), JournalLinesChanged.class.getName(), JournalDateChanged.class.getName(), JournalLinesAdded.class.getName())
                    );
