...
import com.hamzajg.accounting.sale.model.client.ClientCreated;
...
public class ExchangeDispatcher implements Dispatcher<Dispatchable<Entry<String>, State<String>>>, ConfirmDispatchedResultInterest {
    ...
    public ExchangeDispatcher(final Exchange... producerExchanges) {
        this.eventsByExchangeName.put("sales-exchange", new HashSet<>());
        this.eventsByExchangeName.get("sales-exchange").add(ClientCreated.class.getCanonicalName());
