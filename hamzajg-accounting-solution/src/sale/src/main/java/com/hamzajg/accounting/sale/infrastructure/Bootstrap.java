...
import com.hamzajg.accounting.sale.infrastructure.exchange.ExchangeBootstrap;
import com.hamzajg.accounting.sale.infrastructure.persistence.CommandModelJournalStoreProvider;
import com.hamzajg.accounting.sale.infrastructure.persistence.ProjectionDispatcherProvider;
...
@Xoom(name = "sale")
@ResourceHandlers(packages = "com.hamzajg.accounting.sale.infrastructure.resource")
