...
import com.hamzajg.accounting.buying.model.vendor.VendorCreated;
...
public class ExchangeDispatcher implements Dispatcher<Dispatchable<Entry<String>, State<String>>>, ConfirmDispatchedResultInterest {
  ...
  public ExchangeDispatcher(final Exchange ...producerExchanges) {
    this.eventsByExchangeName.put("buying-exchange", new HashSet<>());
    this.eventsByExchangeName.get("buying-exchange").add(VendorCreated.class.getCanonicalName());
